...
public class RemoteUserStoreManagerServiceClient {
     ...
     * user name.
     * @throws RemoteUserStoreManagerServiceUserStoreExceptionException An unexpected exception has occured
     ...
     * @param userName
     * @return
     * @throws RemoteUserStoreManagerServiceUserStoreExceptionException If the realm is not super tenant's this method should throw exception
     * @throws RemoteException
     */
